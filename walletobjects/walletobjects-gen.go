...
// and instantiated from within
// the Android Pay app. This is done by searching for a loyalty or gift
// card
...
type FlightCarrier struct {
	...
	// AirlineLogo: A logo for the airline described by carrierIataCode
	// and
...
// available, different types of bodies will be concatenated if they
// are
// defined.
...
// Patch: Updates the offer class referenced by the given class ID.
// This
// method supports patch semantics.
